...
class Model:
    ...
    def outputClusteringResult(self, outputDir, documentSet):
        ...
        globalOutPath="result/Tweet-TPredTueTextMStream.txt"
        ...
        for batchDoc in batchDocs:
            if batchDoc.text in singleClusterTexts:
        ...
        globalOutPathSemantic="result/Tweet-TPredTueTextMStreamSemantic.txt"		
